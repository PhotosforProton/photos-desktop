...
import { rpc } from "./rpc";
import { cachedPreview, dropPreview, loadPreview } from "./previewStore";
...
export function Lightbox({
  ...
  useEffect(() => {
    ...
    setPreview(cachedPreview(uid) ?? null);
  ...
  return (
    <div className={`lbx ${showDetails ? "with-details" : ""}`} onClick={onClose}>
      ...
      <div className="lbx-stage" onClick={onClose}>
        ...
        {isVideo ? (
          ...
          <PhotoViewer src={preview ?? fallbackUrl ?? undefined} loading={!preview} />
        )}
      ...
      {showDetails && (
        <aside className="lbx-details" onClick={(e) => e.stopPropagation()}>
          ...
          {!details ? (
            ...
            <dl>
              ...
              {details.sha1 && (
                <>
                  <dt>SHA-1</dt>
                  <dd className="lbx-mono">
                    {details.sha1}
                    {details.sha1Verified === false && t("viewer.unverified")}
                  </dd>
                </>
              )}
            </dl>
